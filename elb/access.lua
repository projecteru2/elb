...
-- end
local rule = '{"rules": {"r1": {"args": {"fail": "r3", "pattern": "httpie(\\\\S+)$", "succ": "r2"}, "type": "ua"}, "r2": {"args": {"servername": "127.0.0.1:8088"}, "type": "backend"}, "r3": {"args": {"servername": "127.0.0.1:8089"}, "type": "backend"}}, "init": "r1"}'
